...
<body>
	...
	<div class="container">
		<form name="LoginForm" method="post" class="form-signin"
			...
			<table align="center">
				<tr>
					<td><label for="userEmail" class="sr-only">Email
							address </label> <input type="email" id="userEmail" name="email"
				...
				<tr>
					<td><label for="inputPassword" class="sr-only">Password
						...
						name="password" class="form-control" placeholder="Password" required></td>
				</tr>
				<tr class="blank_row">
					<td colspan="2"></td>
				</tr>
